    ...
    <div class="modal-dialog modal-sm modal-dialog-top" role="document">
        <div class="modal-content p-2 px-3">
            ...
            <div class="modal-body notification-modal">
                <svg id="success" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon d-none" alt="" aria-hidden="true">
                    <path d="M3.478 2.404a.75.75 0 0 0-.926.941l2.432 7.905H13.5a.75.75 0 0 1 0 1.5H4.984l-2.432 7.905a.75.75 0 0 0 .926.94 60.519 60.519 0 0 0 18.445-8.986.75.75 0 0 0 0-1.218A60.517 60.517 0 0 0 3.478 2.404Z" />
                </svg>
                <svg id="failure" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon d-none" alt="" aria-hidden="true">
                ...
                <svg id="not-found" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon d-none" alt="" aria-hidden="true">
                    <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.72 6.97a.75.75 0 1 0-1.06 1.06L10.94 12l-1.72 1.72a.75.75 0 1 0 1.06 1.06L12 13.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L13.06 12l1.72-1.72a.75.75 0 1 0-1.06-1.06L12 10.94l-1.72-1.72Z" clip-rule="evenodd" />
                </svg>
                <p id="modal-message" class="m-0"></p>
            </div>
        </div>
    </div>
</div> 