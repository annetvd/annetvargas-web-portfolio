<?php
    ...
    class PDF extends FPDF{
        ...
        function Header(){
            ...
            $this->SetXY(50,15);
            $this->MultiCell(114,7,utf8_decode('REPORTE DE FACTURAS POR EMPACADORA'),0,'C');
            $this->Ln(10);
            // Arial bold 15
    ...
    $r=mysqli_query($enlace,"select f.IdFolioAporta, e.Nombre as empacadora, f.FolioFactura, f.FechaEmision, f.Cantidad, f.Concepto, f.Estatus, f.Saldo from facturasaporta As f inner join empacadora As e on f.IdEmpacadora = e.IdEmpacadora where f.IdEmpacadora = '".$_POST['empacadora']."'ORDER BY f.FechaEmision DESC");
    ...
    $f=mysqli_query($enlace, "Select Sum(f.Cantidad) FROM facturasaporta As f  where f.IdEmpacadora = '".$_POST['empacadora']."'");
    ...
    $e=mysqli_query($enlace, "Select Sum(f.Saldo) FROM facturasaporta As f where f.IdEmpacadora = '".$_POST['empacadora']."'");
