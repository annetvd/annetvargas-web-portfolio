<?php
    ...
    class PDF extends FPDF{
        function Header(){
            ...
            $this->SetXY(47,15);
            $this->MultiCell(114,7,utf8_decode('ESTADÍSTICAS DE EXPORTACIÓN DE LOS EMPAQUES DE JALISCO'),0,'C');
            $this->Ln(10);
        }
    ...
    $anio = substr($_POST["mesK"], 0 ,4);
    $mes = substr($_POST["mesK"], 5 ,2);
    ...
    $bandera1 = 1;
    while ($bandera1 == 1){
        if(!file_exists('../Imagenes/grafica1.png') && !file_exists('../Imagenes/grafica2.png') && !file_exists('../Imagenes/grafica3.png'))
            $bandera1 = 0;
    }
    ...
    $pdf->Image('../Imagenes/grafica2.png',50,161,111);
    ...
    $pdf->Image('../Imagenes/grafica3.png',21, 53,169);
    ...
    $pdf->SetTitle('Reporte mensual', 1);
